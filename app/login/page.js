...
const page = () => {
  ...
  useEffect(() => {
    document.title="Login - Maheshwari King"
  }, [])
  
  return (
    <div className="text-white container mx-auto flex flex-col items-center py-8">
      <h1 className="font-bold text-2xl">
        Login to get your fans to support you
      </h1>
      <div className="flex flex-col gap-2 min-h-screen  p-10">
        <button onClick={()=>{signIn('google')}} className=" bg-white text-black flex items-center  border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
        ...
        <button className=" bg-white text-black flex items-center  border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
            className="h-6 w-6 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
        ...
        <button onClick={()=>{signIn('github')}} className=" bg-white text-black flex items-center  border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
            className="h-6 w-6 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
